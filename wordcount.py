...
#alternate way to read large files
...
def main():
  ...
  filename = sys.argv[2]
  if option == '--count':
    print_words(word_count_dict(filename)) #or print_words(helper(filename)) for small files
  elif option == '--topcount':
    print_top(word_count_dict(filename)) #or print_top(helper(filename)) for small files
  else:
